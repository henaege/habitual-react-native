  ...
  return(
    <Router>
      ...
      <Scene key="main" title="Your Habits:" >
        <Scene onRight={()=> Actions.addHabit()} rightTitle="Add" key='habitsList' title="Your Habits" component={HabitsList} navigationBarStyle={{backgroundColor:"#48A9A6", opacity: 0.8, paddingTop: (Platform.OS === 'android') ? 14 : 0, paddingBottom: (Platform.OS === 'android') ? 24 : 0, borderColor: 'transparent'}} renderBackButton={() => (null)} initial/>
